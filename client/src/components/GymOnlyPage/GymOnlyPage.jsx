...
export default function GymOnlyPage() {
  ...
  src="https://img.freepik.com/free-photo/group-young-women-stretching-together_23-2148430211.jpg?uid=R181373975&ga=GA1.1.1709772547.1733645509&semt=ais_hybrid"
  alt="Background"
/>
...
<div className="max-w-screen-xl mx-auto my-8">
    <div className="mx-8">
        <div className="flex items-center justify-center mt-4 mb-8">
            <h1 className="text-black text-4xl font-bold">Our Classes</h1>
        </div>
                ...
                <div role="list" className="collection-list-17 w-dyn-items">
                    <div role="listitem" className="w-dyn-item">
                        ...
                        <div  className="w-full h-full relative">
                                <img
                                    src="https://img.freepik.com/free-photo/exercise-machines-gym-without-people_637285-8444.jpg?uid=R181373975&ga=GA1.1.1709772547.1733645509"
                                    loading="lazy"
                                    alt="nothing"
                            ...
                            <div className="bg-[#6624805e] p-5 absolute inset-0 flex flex-col justify-between transition-colors duration-300 ease-in-out hover:bg-[#300a3e5e]">
                                <div className="text-center">
                                    <div className="text-white font-bold text-lg text-shadow-md">Gym Name</div>
                                    <div className="text-white text-sm text-shadow-md text-right mr-2"></div>
                                </div>
                                <div className="text-center absolute inset-x-0 bottom-5">
                                <Link to="/OnlyService"className="bg-[#9C2A46] rounded-lg py-3 px-6 text-white text-lg font-bold transition-colors duration-300 ease-in-out hover:bg-[#2980b9]">
                                        More
                                        </Link>
                                </div>
                            </div>
