...
export default function GymIndoorNurseryPage() {
  ...
  src="https://img.freepik.com/free-photo/mother-with-daughter-gym_1157-14907.jpg?t=st=1742546665~exp=1742550265~hmac=7d51bdfd6ac66a85ebdae799613a91e3ef4a68f5e5341e1aa8a0eaa2f903e5d2&w=1380"
  alt="Background"
/>
                    ...
                    <div role="listitem" className="w-dyn-item">
                        <div className="relative  overflow-hidden shadow-lg w-96 h-88">
                            <div className="w-full h-full relative">
                                <img
                                    src="https://img.freepik.com/free-photo/beautiful-girl-is-engaged-gym_1157-21885.jpg?ga=GA1.1.2031020980.1734978984&semt=ais_hybrid"
                                    loading="lazy"
                                    alt="nothing"
