                ...
                <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6 max-h-[80vh] overflow-y-auto">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="border-b pb-4">
                      ...
                      <p className="font-semibold">{selectedBooking.nursery?.nurseryName || 'Nursery Name Not Available'}</p>
                      <p className="text-gray-600 text-sm">{selectedBooking.nursery?.address || 'Address Not Available'}</p>
                    </div>
