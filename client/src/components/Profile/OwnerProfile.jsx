        ...
        <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6 max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="border-b pb-4">
              ...
              <p className="font-semibold">{selectedBooking.Gym?.gymName}</p>
              <p className="text-gray-600 text-sm">{selectedBooking.Gym?.address}</p>
            </div>
            ...
            <div className="border-b pb-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-medium">{selectedBooking.plan?.name || 'Not specified'}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-500">Price</p>
                  <p className="font-medium">
                    {selectedBooking.plan?.price ? `${selectedBooking.plan.price} JOD` : 'N/A'}
                  </p>
                </div>
                <div>
          ...
          <div className="bg-white rounded-lg">
            ...
            {pastBookings.length === 0 ? (
              ...
              >
                ...
                />
                <p className="font-medium text-lg text-gray-700">
                  You have no Additional Services
                </p>
              </div>
            ) : (
              <div className="space-y-6">
